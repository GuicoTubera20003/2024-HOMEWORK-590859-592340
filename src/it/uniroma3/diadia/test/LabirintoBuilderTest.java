...
public class LabirintoBuilderTest {
	...
	public void testPiuDiQuattroAdiacenti() {
		Labirinto maze = new LabirintoBuilder()
				.addStanzaIniziale(nomeStanzaIniziale)
				.addStanza("stanza 1")
				.addStanza("stanza 2")
				.addStanza("stanza 3")
	...
	public void testLabirintoConStanzaMagica_AggiuntaElementoOltreSogliaMagica() {
		...
		.addAttrezzo(nomeAttrezzo2, peso2);
		Map<String, Stanza> listaStanze = labirintoBuilder.getListaStanze();
		assertEquals(new Attrezzo(nomeAttrezzo2Inv,peso2_x2).getNome(), listaStanze.get(nomeStanzaMagica).getAttrezzo(nomeAttrezzo2Inv).getNome());
		assertEquals(new Attrezzo(nomeAttrezzo1,peso1).getNome(), listaStanze.get(nomeStanzaMagica).getAttrezzo(nomeAttrezzo1).getNome());
	}
